...
export default function SettingsPage() {
  ...
  if (loading) return <div style={{ padding:"32px", color:"#898989" }}>Loading...</div>;

  return (
    <div style={{ padding:"32px", maxWidth:"600px" }}>
      <h1 style={{ fontSize:"28px", fontWeight:"600", color:"#fafafa", margin:"0 0 8px" }}>Settings</h1>
      <p style={{ color:"#898989", margin:"0 0 32px" }}>Manage your profile and preferences</p>
      <div style={{ background:"#1e1e1e", border:"1px solid #2e2e2e", borderRadius:"12px", padding:"24px", marginBottom:"20px" }}>
        <h2 style={{ fontSize:"16px", fontWeight:"600", color:"#fafafa", margin:"0 0 20px" }}>Profile Information</h2>
        <form onSubmit={handleSave} style={{ display:"flex", flexDirection:"column", gap:"16px" }}>
          <div>
            <label style={{ display:"block", fontSize:"13px", color:"#b4b4b4", marginBottom:"6px" }}>Full Name</label>
            <input value={fullName} onChange={e => setFullName(e.target.value)} style={{ width:"100%", padding:"12px 16px", borderRadius:"8px", border:"1px solid #363636", background:"#0f0f0f", color:"#fafafa", fontSize:"14px", outline:"none", boxSizing:"border-box" }} />
          </div>
          <div>
            <label style={{ display:"block", fontSize:"13px", color:"#b4b4b4", marginBottom:"6px" }}>Email</label>
            <input value={profile?.email || ""} disabled style={{ width:"100%", padding:"12px 16px", borderRadius:"8px", border:"1px solid #363636", background:"#171717", color:"#898989", fontSize:"14px", boxSizing:"border-box" }} />
          </div>
          <div>
            <label style={{ display:"block", fontSize:"13px", color:"#b4b4b4", marginBottom:"6px" }}>Role</label>
            <div style={{ padding:"12px 16px", borderRadius:"8px", border:"1px solid #363636", background:"#171717" }}>
